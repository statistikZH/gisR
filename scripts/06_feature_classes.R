...
# Lesen der Gemeindegrenzen
gemeinden <- sf::st_read(
  "https://maps.zh.ch/wfs/OGDZHWFS?SERVICE=WFS&VERSION=2.0.0&Request=getfeature&TYPENAME=ms:ogd-0095_arv_basis_up_gemeinden_seen_f&outputformat=geojson"
  ) |>
  dplyr::rename_all(tolower)
